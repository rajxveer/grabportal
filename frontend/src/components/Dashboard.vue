<template>
  <div class="min-h-screen bg-slate-300">
    ...
    <div v-else class="dashboard p-4">
      ...
      <div class="bg-white rounded-xl p-6 grid grid-cols-4 space-x-4">
        <div>
        ...
        <div class="grid md:flex grid-cols-2 space-x-4 w-full mt-6 justify-end right-0">
          <button @click="getTotalCard(true)"
            class="mt-2 px-4 rounded-lg bg-gray-400 hover:bg-gray-500 font-bold text-white shadow-lg shadow-gray-200 transition ease-in-out duration-200 translate-10">
            Last 30 days
          </button>

          <button @click="getTotalCard(false)"
            class="mt-2 px-4 rounded-lg bg-green-600 hover:bg-green-700 font-bold text-white shadow-lg shadow-green-200 transition ease-in-out duration-200 translate-10">
            Apply
          </button>
        </div>
      </div>
      ...
      <!-- grid wrapper card -->
      <div class="wrapper-card grid grid-cols-3 md:gap-2 mt-5 mb-5">
        <!-- Total payouts card  -->
