      ...
      await DataService.getMOPChart(dateFilter.value)
        .then((res) => {
          ...
          options.value.title.text =
            ...
            " to " +
            dateFilter.value.endDate;
          if (res.data.data.KiplePay) {
            series.value[0].data[0] = res.data.data.KiplePay.count;
          }
          if (res.data.data.paynet) {
            series.value[0].data[1] = res.data.data.paynet.count;
          }
          if (res.data.data.CC) {
            series.value[0].data[2] = res.data.data.CC.count;
          }
